### PORI
https://docs.google.com/spreadsheets/d/1p49I09YQ9g0EuhZdfqXVK8vFr20kWeOcLKz2ifqHCs4/edit?pli=1&gid=0#gid=0
- 4.1 pivot
    * https://openai.com/index/gpt-4-1/
        + improved instruction following and long context
            * try nano?!
    * NO mult task layers for now
- we might be too harsh on long_answers - punishing human nature
- need to focus on "are they real" vs "do we like their answers"

# Pori Gamification
- look at dualingo for comp
- A/B test everything
- deconstructor of fun blog - teardowns

- incentive to invite colleagues - high rewards
- daily use is KEY - durabable business
    * research opportunites
    * profile tuning
        + specilization
        + certifications
    * network curation
        + invitation game - 3 / 5 / 8 / 13 
        + rewards for high qual networks
    * social sharing incentives
    * evergreen surveys
        + build your digital twin
            - goal of sending your avatar into the MR world
    * timeline of activities
        + completes / term / scrubs (get dinged!)
- short term and long term goal formation as drivers
- weighting actions / opportuhties
- scheduling / push notifications of opportunities


panel building - what have we been doing to date on this front vs. what's on deck
operational workflows - triggers
ai moderation (transcription etc) - very cool
researchers - end 2 end ("do it with you")

# TOP OF MIND
--------------
## RF - we need a process
- looks like eng's are using the RF UI to report updates/request changes so that's good
- INCUMBANT on the eng to follow up on the RF coverage request
...
- new e2e theme
    * shared board w/ RF
- if the feature is an update/addition, child ticket in e2e theme
    * assigned to eng
    * new template - xs complexity
    * use to follow-up with RF
